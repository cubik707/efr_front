...
export const setHayfieldsAndPastureImprovedAC = (
...
export const setHayfieldsAndPastureNaturalAC = (
...
//-------Типизация экшенов
type ActionsType =
  | ReturnType<typeof setArableLandAC>
...
//-------Редьюсер
export const landResourcesReducer = (
  state: LandResourcesType = initialState,
  action: ActionsType
): LandResourcesType => {
  switch (action.type) {
