  ...
  switch (action.type) {
    ...
    case 'SET-COST':
      ...
      return {
        ...
        profitability: state.revenue !== 0 ? (calculatedProfit / state.revenue) * 100 : 0 // Пересчитываем рентабельность
      }
    case 'SET-PROFIT':
      ...
      return {
        ...
        profitability: state.revenue !== 0 ? (newProfitFromAction / state.revenue) * 100 : 0 // Пересчитываем рентабельность
      }
    default:
      return state
  }
