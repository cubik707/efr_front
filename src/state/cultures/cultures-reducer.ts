...
// -------Action creators
export const setYieldForecastAC = (
  cultureName: CultureNames,
...
export const setContractDeliveriesAC = (
  cultureName: CultureNames,
...
export const setSellingPricePerCentAC = (
  cultureName: CultureNames,
...
// -------Редьюсер
export const culturesReducer = (
  state: CultureStateType = initialState,
  action: ActionsType
): CultureStateType => {
  switch (action.type) {
