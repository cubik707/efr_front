...
export const gatherData = async (state: AppRootStateType) => {
  const rootObject: RootObject = {
    ...
    hayfieldsAndPastureImproved:
      state.landResources.hayfieldsAndPastureImproved ?? 0,
    hayfieldsAndPastureNatural:
      state.landResources.hayfieldsAndPastureNatural ?? 0,
    ...
    annualGrasses: {
      ...
      sellingPricePerCent:
        state.cultures.annualGrasses.sellingPricePerCent ?? 0,
    },
    cornOnSilage: {
    ...
    haylageGrassHay: {
      ...
      sellingPricePerCent:
        state.cultures.haylageGrassHay.sellingPricePerCent ?? 0,
    },
    greenFodderGrassHay: {
      onFeed: state.cultures.greenFodderGrassHay.onFeed ?? 0,
      yieldForecast: state.cultures.greenFodderGrassHay.yieldForecast ?? 0,
      sellingPricePerCent:
        state.cultures.greenFodderGrassHay.sellingPricePerCent ?? 0,
    },
    hayfieldsOnHay: {
      onFeed: state.cultures.hayImprovedHayfieldsAndPastures.onFeed ?? 0,
      yieldForecast:
        state.cultures.hayImprovedHayfieldsAndPastures.yieldForecast ?? 0,
    },
    hayfieldsOnSilage: {
      onFeed: state.cultures.haylageImprovedHayfieldsAndPastures.onFeed ?? 0,
      yieldForecast:
        state.cultures.haylageImprovedHayfieldsAndPastures.yieldForecast ?? 0,
    },
    pasturesOnGreenFodder: {
      onFeed: state.cultures.greenFodderNaturalHayfieldsAndPastures.onFeed ?? 0,
      yieldForecast:
        state.cultures.greenFodderNaturalHayfieldsAndPastures.yieldForecast ??
        0,
    },
    pasturesOnSilage: {
      onFeed: state.cultures.haylageNaturalHayfieldsAndPastures.onFeed ?? 0,
      yieldForecast:
        state.cultures.haylageNaturalHayfieldsAndPastures.yieldForecast ?? 0,
    },
    hayImprovedHayfieldsAndPastures: {
      sellingPricePerCent:
        state.cultures.hayImprovedHayfieldsAndPastures.sellingPricePerCent ?? 0,
    },
    haylageImprovedHayfieldsAndPastures: {
      sellingPricePerCent:
        state.cultures.haylageImprovedHayfieldsAndPastures
          .sellingPricePerCent ?? 0,
    },
    haylageNaturalHayfieldsAndPastures: {
      sellingPricePerCent:
        state.cultures.haylageNaturalHayfieldsAndPastures.sellingPricePerCent ??
        0,
    },
    greenFodderNaturalHayfieldsAndPastures: {
      sellingPricePerCent:
        state.cultures.greenFodderNaturalHayfieldsAndPastures
          .sellingPricePerCent ?? 0,
    },
    milk: {
      price: state.livestockProducts.milk.costPrice ?? 0,
      sellingPricePerCent:
        state.livestockProducts.milk.sellingPricePerCent ?? 0,
    },
    meat: {
      price: state.livestockProducts.cattleMeat.costPrice ?? 0,
      sellingPricePerCent:
        state.livestockProducts.cattleMeat.sellingPricePerCent ?? 0,
    },
    concentrates: {
