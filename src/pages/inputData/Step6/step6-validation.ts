...
const rowSchema = (isPriceDisabled: boolean) =>
  Yup.object().shape({
...
export const validationSchema = Yup.object()
  .shape(
    Object.keys(cultures)
      ...
      .reduce<Record<CultureNames, Yup.ObjectSchema<any, any, any, any>>>(
        (acc, culture) => {
          acc[culture as CultureNames] = rowSchema(
            disabledPriceCultures.includes(culture)
          )
          return acc
        },
